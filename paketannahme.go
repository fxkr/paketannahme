...
func Protect(expectedUsername, expectedPassword []byte, handler http.HandlerFunc) http.HandlerFunc {
...
// Returns 1 iff no value equals 0, 0 otherwise.
...
// Returns 1 if expected == actual, 0 otherwise.
...
func (self RateLimit) Limit(handler http.HandlerFunc) http.HandlerFunc {
